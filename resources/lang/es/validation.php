...
return [
    ...
    */
    ...
    'custom' => [
        'username' => [
            'max' => 'El nombre de usuario puede tener hasta :max caracteres.',
        ...
        'password' => [
            'max' => 'La contraseña puede tener hasta :max caracteres.',
            'confirmed' => 'Las contraseñas ingresadas no coinciden.'
        ],
        'title' => [
            'required' => 'La película debe tener un título.'
        ],
        'rating' => [
            'required' => 'La película debe tener un rating.'
        ],
        'release_date' => [
            'required' => 'La película debe tener una fecha de lanzamiento.'
        ]
    ],
